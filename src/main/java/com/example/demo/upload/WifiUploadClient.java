...
//    public WifiUploadClient(String fileName, String userId, String token) {
	...
	public int startToSend() {
		...
		if (tfile.exists()) {
			...
			if (tfile.exists()) {
				...
				try {
					// Md5Utils
//                    mclient = new FileWebSocketClient(new URI(SERVER_URL),headers
//                            ,this.mfileName,this.muserId,this.mtoken);
