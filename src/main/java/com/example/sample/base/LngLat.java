...
public final class LngLat implements Cloneable {
    ...
    /**
     * 使用传入的经纬度构造LngLat 对象,一对经纬度值代表地球上一个地点.
     *
    ...
    /**
     * 使用传入的经纬度构造 LatLng 对象,一对经纬度值代表地球上一个地点
     *
     * @param longitude 地点的经度,在-180 与180 之间的 double 型数值.
     * @param latitude  地点的纬度,在-90 与90 之间的 double 型数值.
     * @param isCheck   是否需要检查经纬度的合理性,建议填写 true
     */
